...
export default function ResumeHeader() {
    return (
        <section className="pt-40 pb-24 relative overflow-hidden">
            <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-amber-900/10 blur-[160px] rounded-full pointer-events-none" />
            ...
            <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10 px-6">
                ...
                >
                    AI-native engineer specializing in advanced RAG systems,
                    agentic architectures, and production AI deployment.
                </motion.p>
